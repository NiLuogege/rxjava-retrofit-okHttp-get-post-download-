package com.example.well.rxjavaandretrofit_doctor.net.rxretrofit.utils;

import android.content.Context;
import android.database.sqlite.SQLiteDatabase;

import com.example.well.rxjavaandretrofit_doctor.net.rxretrofit.RxRetrofitApp;
import com.example.well.rxjavaandretrofit_doctor.net.rxretrofit.download.DaoMaster;
import com.example.well.rxjavaandretrofit_doctor.net.rxretrofit.download.DaoSession;
import com.example.well.rxjavaandretrofit_doctor.net.rxretrofit.http.cookie.CookieResulte;
import com.example.well.rxjavaandretrofit_doctor.net.rxretrofit.http.cookie.CookieResulteDao;
