...
import com.example.well.rxjavaandretrofit_doctor.BuildConfig;
...
import com.example.well.rxjavaandretrofit_doctor.net.rxretrofit.http.cookie.CookieResulte;
...
import com.example.well.rxjavaandretrofit_doctor.net.rxretrofit.utils.CookieDbUtil;
...
public class ProgressSubscriber<T> extends Subscriber<T> {
    ...
    public void onNext(T t) {
        if (BuildConfig.DEBUG) Log.d("ProgressSubscriber", "onNext");
        if (mSubscriberOnNextListener.get() != null) {
